    ...
    <div className="min-h-screen bg-[#111111] text-white">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              ...
              through AI-powered consumer simulation and behavioral analysis
            </p>
              ...
              <div className="bg-black rounded-lg p-6 mb-6">
                ...
                <div className="space-y-2 text-sm">
                  <div className="text-gray-300">
                    Running consumer simulation...
                  </div>
                  <div className="text-white">
                    Analyzing behavioral patterns for target demographic
                  </div>
                  <div className="text-gray-300">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Building Real Person Agents to understand human behavior through
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Discover how leading companies leverage AI personas to gain deep
              consumer insights and drive strategic decisions
            </p>
          </div>
              ...
              <div className="bg-[#1a1a2a] p-6">
                ...
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-300 text-sm">
                    Run comprehensive A/B tests with AI personas to validate
                    product concepts and user experiences before launch
                  </p>
                </CardContent>
              </div>
            </Card>
            ...
            <Card className="bg-[#1a1a1a] border-gray-700 overflow-hidden">
              <div className="bg-[#2a1a2a] p-6">
                ...
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-300 text-sm">
                    Develop data-driven strategies using AI-generated consumer
                    insights and behavioral predictions
                  </p>
                </CardContent>
              </div>
            </Card>
            ...
            <Card className="bg-[#1a1a1a] border-gray-700 overflow-hidden">
              <div className="bg-[#1a2a1a] p-6">
                ...
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-300 text-sm">
                    Uncover deep consumer motivations and preferences through
            ...
            <Card className="bg-[#1a1a1a] border-gray-700 overflow-hidden">
              <div className="bg-[#2a2a1a] p-6">
                ...
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-300 text-sm">
                    Generate personalized content and experiences tailored to
            ...
            <Card className="bg-blue-600 border-0 text-white">
              <CardContent className="p-6">
                ...
                <p className="text-blue-100 text-sm">
                  Create detailed AI personas based on your target demographics
                  and behavioral data
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-green-600 border-0 text-white">
              <CardContent className="p-6">
                ...
                <p className="text-green-100 text-sm">
                  Conduct automated interviews with AI personas to gather
            ...
            <Card className="bg-purple-600 border-0 text-white">
              <CardContent className="p-6">
                ...
                <p className="text-purple-100 text-sm">
                  Analyze patterns and preferences to understand consumer
            ...
            <Card className="bg-orange-600 border-0 text-white">
              <CardContent className="p-6">
                ...
                <p className="text-orange-100 text-sm">
                  Receive actionable insights and recommendations within minutes
                  of completion
                </p>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300">
              Real examples of how companies use atypica to drive business
              decisions
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Research on shopping cart abandonment and digital experience preferences",
                color: "bg-blue-600",
              },
              {
                title: "Mobile App User Experience",
                description:
                  "Understanding user behavior patterns and feature adoption rates",
                color: "bg-green-600",
              },
              {
                title: "Brand Perception Analysis",
                description:
                  "Deep dive into consumer sentiment and brand positioning effectiveness",
                color: "bg-purple-600",
              },
              {
                title: "Product Launch Validation",
                description:
                  "Pre-launch testing with AI personas to predict market reception",
                color: "bg-orange-600",
              },
              {
                title: "Customer Journey Mapping",
                description:
                  "Comprehensive analysis of touchpoints and conversion optimization",
                color: "bg-red-600",
              },
              {
                title: "Pricing Strategy Research",
                description:
                  "Understanding price sensitivity and willingness to pay across segments",
                color: "bg-indigo-600",
              },
            ].map((study, index) => (
              <Card
                key={index}
                className="bg-[#1a1a1a] border-gray-700 overflow-hidden hover:border-gray-700 transition-colors"
              >
      ...
      <section className="py-20 px-6 bg-[#1a1a1a]">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">
              AI Personas from Deep Interviews
            </h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
              Discover how behavioral research from real interviews helps build
              more accurate AI personas that understand consumer motivations and
              decision-making processes
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="text-gray-300">
                <p className="mb-4">
                  "We used atypica to Personas as a form of high-powered
                  consumer research that helps us understand our customers at a
                  much deeper level than traditional surveys."
                </p>
                <p className="mb-4">
                  Our data shows that behavioral insights increase sales
                  performance by 40% and reduce customer acquisition costs by
                  25% when properly implemented in Personas for real business
                  impact.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-300 text-sm">
                    Target audience analysis across 15+ demographic segments
                  </p>
                </div>
                <div>
                  <h4 className="text-white font-medium">
                  ...
                  <p className="text-gray-300 text-sm">
                    Deep understanding of purchase motivations and decision
                    factors
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-300 text-sm">
                    Analysis across multiple markets and consumer segments
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-yellow-400 rounded-2xl p-8 text-black">
              ...
              <div className="text-sm opacity-80">
                of predictions match real consumer behavior in validation
                studies
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-4xl font-bold mb-6">
            Build Your Custom AI Research Panel
          </h2>
          <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
            Start understanding your customers at a deeper level with AI-powered
            persona research that delivers insights in minutes, not months
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              variant="outline"
              className="border-gray-700 text-gray-300 hover:bg-gray-800 px-8 py-3"
            >
              View Demo
            </Button>
          </div>
